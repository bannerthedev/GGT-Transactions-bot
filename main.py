...
# ---------------- CONFIG (fill these) ----------------
GUILD_ID = 1472622389321011212  # your guild/server ID

# channels
# channels
TRANSACTIONS_ID = 1507443553926905967
MATCH_TIMES_CHANNEL_ID = 1507882008297082980
ASSIGNMENTS_CHANNEL_ID = 1507879432897953883
SCRIM_CATEGORY_ID = 0  # put your Scheduling category ID here, or 0 to create/use none
MATCH_SCORES_CHANNEL_ID = 1507451603236425738  # put your match-score channel ID here

# staff/team roles
CAPTAIN_ROLE_ID = 1492675736081797284
CO_CAPTAIN_ROLE_ID = 1492675839404277810
EXECUTIVE_ROLE_ID = 1492675650857992352
TEAM_PLAYER_ROLE_ID = 1492675908413161652

# assignment roles
HEAD_REF_ROLE_ID = 1507879819092824165
REF_ROLE_ID = 1492676869575938108
HEAD_CASTER_ROLE_ID = 1472625844693368954
CASTER_ROLE_ID = 1472625873445191974

FAQ_CHANNEL_ID = 1507442431803658290  # replace with the channel ID where FAQ should be posted
STREAM_WATCHER_ROLE_ID = 1507882465300185148  # 🎥 Stream Watcher
UNBORN_CAPTAIN_ROLE_ID = 1507882528218812466  # 🚀 Unborn Captain
EVENT_PING_ROLE_ID = 1507882585668190249     # 🎉 Event Ping
...
async def info(interaction: discord.Interaction):
    embed = discord.Embed(
        title="GGT Transactions Bot – Command Guide",
    ...
    embed.add_field(
        ...
        value="Change the team's captain (e.g. banner1234 to cgt.bender).",
        inline=False,
    )
    embed.add_field(
...
async def admin_info(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        title="GGT Transactions Bot – Admin Command Guide",
...
@bot.tree.command(
    guild=GUILD_OBJ,
    name="faq",
    description="Post the GGT FAQ and auto-role buttons (admins only)."
)
async def faq(interaction: discord.Interaction):
    ...
    text = (
        "# Global Gorilla Tag Frequently Asked Questions\n\n"
        ...
        "## • Application Forms\n\n"
        "> - GGT has a various list of positions and applications to better help the league!,\n"
...
async def code(interaction: discord.Interaction, team1: discord.Role, team2: discord.Role):
    ...
    await interaction.response.defer(ephemeral=True)
    code_value = f"GGT{random.randint(1000, 9999)}"
